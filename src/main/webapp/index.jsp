...
#bg {
	...
	width: 100%;
	height: 100%;
	background: url(http://lorempixel.com/800/500/nature) no-repeat center
		center fixed;
...
<body>
	...
	<form action="loginsss" method="post">
		...
		<input type="text" name="fname" id=""placeholder="First name" class="pass">
 		<input type="text" name="sname" id="" placeholder="Second name" class="pass">
  		<input type="text" name="uname" id="" placeholder="User name" class="pass">
